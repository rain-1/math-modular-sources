...
print("point x0=-1"); sol(p1,50); sol(p1,100); sol(p1,200); sol(p1,400); sol(p1,650);
print("point x0=-3"); sol(p2,100); sol(p2,400); sol(p2,650);
print("point x0=-6"); sol(p3,100); sol(p3,400); sol(p3,650);
...
print("residuals"); res(p1,650); res(p2,650); res(p3,650);
quit
