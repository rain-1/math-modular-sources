...
print("=== shape A: r=22, D=23 (minimal recurrence order) ===");
resA = reconstruct(22, 23, 8);
print("  pivot index = ", resA[1]);
ciA = verify(22, 23, resA[2]);
write("/home/ubuntu/code/math-modular-sources/lattice/multislope/row4_recA.txt", ciA);
print("  max coeff digits = ", vecmax(vector(#ciA,b,#Str(abs(ciA[b])))));
quit
