...
write("/home/ubuntu/code/math-modular-sources/lattice/multislope/row4_An.txt", An);
write("/home/ubuntu/code/math-modular-sources/lattice/multislope/row4_Bn.txt", Bn);
print("written");
quit
